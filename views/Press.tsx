    ...
    <div className="pt-40 pb-20 bg-artbar-bg min-h-screen">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        <div className="relative mb-32 group">
          <button 
            onClick={() => scroll('left')} 
            className="absolute left-0 top-1/2 -translate-y-1/2 -ml-4 z-20 bg-white shadow-lg w-12 h-12 rounded-full flex items-center justify-center text-artbar-navy hover:scale-110 transition-all opacity-0 group-hover:opacity-100 disabled:opacity-0"
          ...
          <button 
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 -mr-4 z-20 bg-white shadow-lg w-12 h-12 rounded-full flex items-center justify-center text-artbar-navy hover:scale-110 transition-all opacity-0 group-hover:opacity-100"
          ...
          <div 
            ref={scrollRef}
            className="flex overflow-x-auto gap-6 pb-8 hide-scrollbar snap-x snap-mandatory px-2"
            style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
          >
            {content.media.map((item, idx) => (
              <div 
                key={idx} 
                className="flex-shrink-0 w-[280px] h-[400px] relative rounded-[2rem] overflow-hidden shadow-lg snap-center bg-gray-200 group/card transition-transform hover:-translate-y-2 duration-300"
              >
                <img 
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-end text-white">
                  ...
                  <div>
                    ...
                    <p className="font-mono text-sm opacity-80 bg-artbar-navy/50 inline-block px-2 py-1 rounded backdrop-blur-sm border border-white/20">
                      {item.date}
                    </p>
                  </div>
                </div>
        ...
        {/* Popups Timeline */}
        <div className="bg-artbar-navy text-white rounded-[3rem] p-8 md:p-24 shadow-2xl relative overflow-hidden">
