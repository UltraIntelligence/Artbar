...
export const DEFAULT_JAPANESE_UI_COPY = {
  ...
  themeDetail: {
    ...
    upcomingClassesTitle: '今後の{{name}}クラス',
    upcomingClassesSub: '次回開催予定のクラスをご覧ください。横にスワイプすると、ほかの日程も確認できます。',
...
export const DEFAULT_ENGLISH_UI_COPY = {
  ...
  themeDetail: {
    ...
    upcomingClassesTitle: 'Next {{name}} Classes',
    upcomingClassesSub: 'See the next scheduled classes. Swipe to explore more dates.',
