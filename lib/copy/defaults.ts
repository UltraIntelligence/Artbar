...
export const DEFAULT_JAPANESE_UI_COPY = {
  ...
  home: {
    ...
    bookTeamBuildingCta: '法人向けプランを見る',
  ...
  themeDetail: {
    ...
    upcomingClassesTitle: '{{name}}の今後1週間のクラス',
    upcomingClassesSub: '現在予約できるクラスをご覧ください。横にスワイプすると、ほかの日程も確認できます。',
...
export const DEFAULT_ENGLISH_UI_COPY = {
  ...
  home: {
    ...
    bookTeamBuildingCta: 'View Team-Building Options',
  ...
  themeDetail: {
    ...
    upcomingClassesTitle: 'Upcoming {{name}} Classes',
    upcomingClassesSub: 'See what is available over the next seven days. Swipe to explore more dates.',
